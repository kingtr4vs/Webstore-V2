          ...
          <section className="mt-16">
            <div className="glass rounded-xl p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Purchase keys to open crates and receive random rewards. Higher tier keys have better chances for rare
                and valuable items. All items are delivered instantly to your in-game inventory.
              </p>
