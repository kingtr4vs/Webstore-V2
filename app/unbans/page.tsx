        ...
        <section className="pt-24 pb-16 relative overflow-hidden min-h-[60vh] flex items-center">
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Get Back In The
              <span className="block gradient-primary bg-clip-text text-transparent">Game</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Made a mistake? Our professional unban services help you return to the server quickly and fairly. Choose
              the service that matches your situation.
            </p>
          </div>
        </section>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-3">
                      Unban services are reviewed case-by-case. Not all bans are eligible for removal. Purchasing an
                      unban service does not guarantee unbanning - it guarantees a thorough review of your case.
                    </p>
